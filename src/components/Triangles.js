...
TriangleBG.prototype.generateNet = function() {
   ...
   this.net.w = Math.floor(window.screen.width/this.net.cellWidth) + this.render.pad*2; //+4 for edges
   this.net.h = Math.floor(window.screen.height/this.net.cellHeight) + this.render.pad*2;
   //render padding
