    ...
    <div className="projects-main">
      <div className="content-container">
        ...
        <div className="projects-content">
          <Project
            imgSrc={ywk}
            title="Yes We Kanban Board"
            shortDescription={
              <p>A simple kanban board to organise your projects</p>
            }
            longDescription={`<h3 class="modal-subtitle">Description</h3>
                        <p>My kanban board allows you to easily organise the to do tasks in your project. 
                        It allows for authentication via Google, Github or anonymously - this means your projects are saved in the cloud! Add as many columns/tasks/projects as you want!</p>
                        <h3 class="modal-subtitle">Links</h3>
                        <p>
                        <a href="https://ywk.alex-pham.com/" class="demo">Demo</a>
                        </p>
                        <p>
                        <a href="https://github.com/baapham/Yes-We-Kanban-Board" class="demo">Github</a>
                        </p>
          ...
          <Project
            ...
            shortDescription={
              <p>
                A clone of IMDb, search for movies, get their ratings and more
              </p>
            }
            longDescription={`<h3 class="modal-subtitle">Description</h3>
          ...
          <Project
            ...
            shortDescription={
              <p>
                A medium to connect conference attendees and organisers together
              </p>
            }
            longDescription={`<h3 class="modal-subtitle">Description</h3>
          ...
          <Project
            ...
            shortDescription={
              <p>
                A portfolio to show my projects, it is also happens to be this
                website
              </p>
            }
            longDescription={`<h3 class="modal-subtitle">Description</h3>
          ...
          <Project
            ...
            title="Countdown"
            shortDescription={
              <p>A simulation of the TV show of the same name</p>
            }
            longDescription={`<h3 class="modal-subtitle">Description</h3>
