        ...
        <div className="about-main">
            <div className="content-container">
                <div className="about-all">
                    ...
                    <p>I currently am in my 3rd year of univeristy (UNSW) studying a double degree of Computer Science and Commerce (Finance).
                    ...
                    help host one of the biggest Australian servers at that time (to be fair there was only about 5 Aussie servers) and develop websites for my gaming clans.
